...
import kotlinx.android.synthetic.main.app_bar_workspace.*

class WorkspaceActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.workspace, menu)
        return true
    }
